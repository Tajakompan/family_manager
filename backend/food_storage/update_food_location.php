...
if ($id <= 0 || $storage_location <= 0 || $product_category <= 0 || $product_name == "" || $product_amount <= 0 || $product_unit == "" || $product_quantity <= 0 || $product_status == ""){
...
// pogleda ce tocno tak zapis ze obstaja
$sql = "SELECT id
        FROM food_location
        WHERE family_id = ?
