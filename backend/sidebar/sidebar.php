...
<aside class="sidebar" id="app_sidebar">
    <button class="sidebar-toggle" type="button" id="sidebar_toggle" aria-controls="app_sidebar" aria-expanded="false" aria-label="Odpri meni">&#9776;</button>
...
<script src="../../frontend/sidebar/sidebar_toggle.js"></script>
